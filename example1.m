...
%Magnetopause2
t = irf_time([2002 03 30 13 11 00]);
tint = t+[0 180];
...
%Alternative
R1 = irf_get_data('sc_r_xyz_gse__C1_CP_AUX_POSGSE_1M','caa','mat');
R2 = irf_get_data('sc_r_xyz_gse__C2_CP_AUX_POSGSE_1M','caa','mat');
R3 = irf_get_data('sc_r_xyz_gse__C3_CP_AUX_POSGSE_1M','caa','mat');
R4 = irf_get_data('sc_r_xyz_gse__C4_CP_AUX_POSGSE_1M','caa','mat');


%calls c_4_timing_mva
column = 4; % z-component of magnetic field (2=x, 3=y, 4=z).
c_4_v_timing_mva('gseMagC?','R?',column);